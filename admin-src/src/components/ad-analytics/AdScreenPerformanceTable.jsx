              ...
              {rows.map((r, i) => (
                <tr key={`${r.screen_context}-${r.ad_format}-${i}`} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2.5 text-gray-500">
                    <span className="text-xs px-1.5 py-0.5 rounded bg-gray-100 text-gray-700">{r.ad_format}</span>
                  </td>
                  ...
                  <td className="px-4 py-2.5 text-right text-blue-600 font-medium">{formatUsd(r.revenue_usd)}</td>
